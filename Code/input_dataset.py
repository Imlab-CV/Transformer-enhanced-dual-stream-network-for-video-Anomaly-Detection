...
class Anomaly_Loader(Dataset):
    ...
    is_train = 1 <- train, 0 <- test
    """
    def __init__(self, is_train=1, path='UCF-Crime/', modality='FLOW'):
    ...
    def __getitem__(self, idx):
        if self.is_train == 1:
            ...
            # Add debugging code here to inspect the data_list[idx] and its length
           # print(f"Index {idx}: {self.data_list[idx]}")
           # print(f"Length of data_list: {len(self.data_list)}")
